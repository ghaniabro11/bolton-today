...
const AuthRedirectPage = async ({ params }: { params: Promise<{ slug: string }> }) => {
  ...
  redirect(`/contributor/${slug}`);
};

export default AuthRedirectPage;
// import { getJournalistNewsWithCategoriesOptimized } from "@/app/actions/client-actions/contributor";
...
// //     // Canonical URL
// //     alternates: {
// //       canonical: `https://boltontoday.co.uk/contributor/${slug}/page/${page}`,
// //     },
...
//   const { slug, page } = await params;
//   if (page === "1") {
//     permanentRedirect(`/contributor/${slug}`);
//   }
