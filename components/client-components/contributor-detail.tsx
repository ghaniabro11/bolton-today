...
const ContributorDetailComponent = ({
  result,
  slug,
}: {
  result: any;
  ...
  const contributorData = result?.data?.contributor as any;
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="shrink-0">
            <div className="relative">
              {contributorData?.image?.filePath ? (
                <Image
                  src={contributorData?.image.filePath}
                  alt={contributorData?.image.title || "Contributor Image"}
                  width={160}
                  height={160}
          ...
          <div className="flex-1 space-y-6">
            ...
            {contributorData?.description && (
              <div>
                ...
                {contributorData?.description.length > 200 && (
                  <button
            ...
            {/* Social Links */}
            {Object.values(contributorData?.socialLinks || {}).some(Boolean) && (
              <div>
                <h3 className="text-sm font-semibold text-gray-900 mb-3 uppercase tracking-wide">
                  Connect With Me
                </h3>
                <div className="flex flex-wrap gap-3">
                  {Object.entries(contributorData?.socialLinks || {}).map(
...
export default ContributorDetailComponent;
